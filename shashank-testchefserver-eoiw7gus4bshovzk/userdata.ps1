<powershell>
 ...
 $env:CHEF_SERVER_NAME = "shashank-testchefserver" # Name of your Chef Server
 $env:CHEF_SERVER_ENDPOINT = "shashank-testchefserver-eoiw7gus4bshovzk.us-east-1.opsworks-cm.io" # FQDN of your Chef Server
