...
CHEF_SERVER_NAME="shashank-testchefserver" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="shashank-testchefserver-eoiw7gus4bshovzk.us-east-1.opsworks-cm.io" # The FQDN of your Chef Server
