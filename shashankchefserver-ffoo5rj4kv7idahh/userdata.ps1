<powershell>
 ...
 $env:CHEF_SERVER_NAME = "shashankchefserver" # Name of your Chef Server
 $env:CHEF_SERVER_ENDPOINT = "shashankchefserver-ffoo5rj4kv7idahh.us-east-1.opsworks-cm.io" # FQDN of your Chef Server
