...
CHEF_SERVER_NAME="shashankchefserver" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="shashankchefserver-ffoo5rj4kv7idahh.us-east-1.opsworks-cm.io" # The FQDN of your Chef Server
